...
export const workData: WorkItem[] = [
  ...
  },
  {
    ...
    category: '신청하기',
    icon: '📝',
    imagePaths: ['/images/013.jpg', '/images/014.jpg'],
    description: '홈페이지 이용을 위한 회원가입 및 가입자 웹등록 방법 안내',
    menuPath: '홈페이지 > 가입자웹등록',
    shortDesc: '회원가입',
    keywords: ['회원가입', '가입자웹등록', '웹등록', '홈페이지가입', '가입', '계정생성']
  },
  {
    id: 3,
    title: '신규직원 등록하기',
    category: '직원관리',
    icon: '👤',
    imagePaths: ['/images/015.jpg', '/images/016.jpg'],
  ...
  },
  {
    ...
    category: '직원관리',
    icon: '💰',
    imagePaths: ['/images/019.jpg', '/images/020.jpg'],
  ...
  },
  {
    ...
    category: '직원관리',
    icon: '📋',
    imagePaths: ['/images/029.jpg', '/images/030.jpg', '/images/031.jpg'],
  ...
  },
  {
    ...
    category: '직원관리',
    icon: '📊',
    imagePaths: ['/images/040.jpg', '/images/041.jpg'],
  ...
  },
  {
    ...
    category: '부담금',
    icon: '📊',
    imagePaths: ['/images/023.jpg', '/images/024.jpg', '/images/025.jpg'],
